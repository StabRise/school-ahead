...
import { speak, type SpeechLanguage as GameLanguage } from "@school-ahead/api-client";
import { QuizAnswerButton, QuizBanner, QuizCard, QuizFeedbackOverlay, QuizReadAloudButton } from "@school-ahead/preschool-ui";
...
function mascotForScore(correctCount: number): string {
  if (correctCount <= 2) return "/static/quiz/chicken.jpeg";
  if (correctCount <= 4) return "/static/quiz/dragon.jpeg";
  return "/static/quiz/owl.jpeg";
}
