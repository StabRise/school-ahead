import type {
  ...
  AvatarOut,
  UserOut,
} from "./browser/schoolAheadAPI.schemas";
import type { AuthUser, EquippedAvatarItem } from "./auth-store";
...
export function mapApiUserToAuthUser(user: UserOut): AuthUser {
  return {
    ...
    schoolClassId: user.school_class_id ?? null,
    schoolClassName: user.school_class_name ?? null,
