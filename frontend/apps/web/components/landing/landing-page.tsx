...
const EXPLORE_CARDS = [
  { key: "subjects", href: "/subjects", image: "/images/landing/subjects.jpg", width: 210 },
  { key: "stories", href: "/games/stories", image: "/images/landing/stories.jpg", width: 210 },
  { key: "games", href: "/games", image: "/images/landing/games.jpg", width: 250 },
] as const;
      ...
      <section className="mx-auto grid w-full max-w-6xl flex-1 items-center gap-8 px-6 py-10 lg:grid-cols-2 lg:gap-12 lg:py-16">
        <div className="flex flex-col items-start gap-6 lg:order-2">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              href="/login"
              className={`rounded-xl bg-gradient-to-b from-sky-400 to-blue-600 px-6 py-3 text-base font-semibold text-white shadow-lg shadow-blue-500/30 transition hover:brightness-105 ${focusRing}`}
            >
              {t("createAccount")}
            </Link>
            <a
          ...
          {EXPLORE_CARDS.map(({ key, href, image, width }) => (
            <li key={key}>
              ...
              >
                ...
                />
                <span className="text-xl font-semibold text-slate-900">{t(key)}</span>
              </Link>
            </li>
          ))}
        </ul>
