...
import { StoryRichTextEditor } from "@/components/tutor/story-rich-text-editor";

// Edit/preview toggle for Story.content — same convention as
// components/markdown-editor.tsx, but with two authoring aids specific to
// stories, both implemented in StoryRichTextEditor:
...
//     stays the plain "{ <url> }" text (see lib/story-rich-text.ts);
//   - selecting a word shows a floating "format as card" button (see
//     lib/story-card-format.ts) that rewrites it into the same
//     consonant+vowel/м'який знак card breakdown the reading minigame itself
//     uses, e.g. "яблуко" -> "{я-б-лу-ко}".
