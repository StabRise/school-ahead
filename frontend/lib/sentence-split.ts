// Splits pasted text into paragraphs and sentences so a page can render
// each sentence as its own highlightable span while handing the same
// sentences to piper-tts's speakSequence() (lib/piper-tts.ts) for
// read-aloud playback with per-sentence progress.
